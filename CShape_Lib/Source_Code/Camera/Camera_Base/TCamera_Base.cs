...
namespace EFC.Camera
{
    ...
    public class TCamera_Base
    {
        ...
        public string                    Log_Source = "TCamera_Base";
        ...
        public bool                      Rotate_Image = false;
        ...
        public TCamera_Base()
        {
            ...
            Image.GenImageConst("byte", Image_Width, Image_Height);
            Select_Image.GenImageConst("byte", Image_Width, Image_Height);
        }
        ...
        {
            string fun = "On_Grab_Timeout";

            Log_Add(fun, "Camera=" + Name + " On_Grab_Timeout.", emLog_Type.Error);
            Timer_Grab_Timeout.Enabled = false;
        ...
        virtual public void Set_Log(TLog value)
        {
            inLog = value;
            //Socket.Log = log;
        }
